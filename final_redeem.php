...
<head>
    ...
    <title>Final Coupon Redemption</title>
...
<body>
    <div class="container mt-4">
        <h1 class="mb-4">Final Coupon Redemption</h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <p>Quick Links:</p>
                    <a href="?coupon_code=BLACK-1" class="btn btn-sm btn-outline-primary">BLACK-1</a>
                    <a href="?coupon_code=1" class="btn btn-sm btn-outline-primary">1</a>
                    <a href="?coupon_code=BLACK-2" class="btn btn-sm btn-outline-primary">BLACK-2</a>
                    <a href="?coupon_code=2" class="btn btn-sm btn-outline-primary">2</a>
                </div>
            </div>
        </div>
